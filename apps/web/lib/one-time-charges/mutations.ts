...
export function useAddOneTimeCharge(): MutationResult<
  [string, AddOneTimeChargeRequest],
  InvoiceLineItem
> {
  return useApiMutation((invoiceId: string, body: AddOneTimeChargeRequest) =>
    api.oneTimeCharges.add(invoiceId, body),
  );
}
